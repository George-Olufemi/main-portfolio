  ...
  return (
    <div className="mb-20">
        ...
        <div class="flex justify-center items-center mb-5">
            ...
            <button action="mailto: georgeoluolufemi@gmail.com" method="post" className="text-white text-center font-semibold text-xl bg-blue-600 px-6 py-2 rounded-xl hover:scale-110 ml-8 transition-all hover:bg-blue-500">Mail me</button>
        </div>
    </div>
  )
}
